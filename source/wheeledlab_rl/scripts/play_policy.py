    ...
    for time_idx in tqdm(range(args_cli.steps), desc="Playing policy"):
        ...
        with torch.inference_mode():
            ...
            if action_testing:
                MAX_SPEED = 10
                # CMD_SPEED = 5
                CMD_TO_REAL_MULTIPLIER = 1.2  # This is the multiplier to convert command speed to real speed
                # SET_SPEED = CMD_SPEED / CMD_TO_REAL_MULTIPLIER 

                MAX_ANGLE = 0.40
                # CMD_ANGLE = 0.0
                # CMD_TO_REAL_MULTIPLIER_ANGLE = 1.3  # This is the multiplier to convert command angle to real angle
...
##############################################################
    ...
    ax1.plot(time[start_idx:end_idx], actions[start_idx:end_idx, 0, 0]*MAX_SPEED*CMD_TO_REAL_MULTIPLIER, 
